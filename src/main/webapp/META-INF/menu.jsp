                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h1 class="box-title"><b>Jardineria El Corazon Verde</b></h1>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-4">
                                                    <h4>Consejos de Jardinería</h4>
                                                    <p>Descubre consejos útiles para mantener tus plantas saludables y hermosas durante todo el año.</p>
                                                    <a href="#" class="btn btn-success">Ver más</a>
                                                </div>

                                                <div class="col-xs-12 col-sm-6 col-md-4">
                                                    <h4>Plantas y Flores</h4>
                                                    Explora nuestra variedad de plantas y flores para embellecer tu jardín.</p>
                                                    <a href="#" class="btn btn-success">Ver más</a>
                                                </div>
                                            </div>     
                                            <!-- End of your content -->
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="thumbnail">
                                            <a href="" target="_blank">
                                                <div class="caption">
                                                    <p class="c" >  Descubre hermosos jardines.</p>
                                                </div>
                                                <img src="ima/jardin.jpg" alt="Jardín" style="width:90%">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="thumbnail">
                                            <a href="" target="_blank">
                                                <div class="embed-responsive embed-responsive-4by3" style="padding-bottom: 0%;">
                                                    <p class="c" >  Hermosos Trabajos </p><br> 
                                                </div> 
                                                <img src="ima/jardin2.jpg" alt="Jardín" style="width:100%">
                                            </a>                                        
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="thumbnail">
                                            <a href="" target="_blank">
                                                ...
                                                <img src="ima/plantas.jpg" alt="Plantas" style="width:90%">                                                
                                            </a>
                                        </div>
                                    </div>
                                </div><!-- /.box-body -->
